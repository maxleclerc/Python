...
def loco():
    while True:
        f1 = open('.\data\loc0.txt', 'r')
        f2 = open('.\data\loc1.txt', 'r')
        f3 = open('.\data\loc2.txt', 'r')
        print('\n' * 3)
        print(f1.read())
        sleep(0.25)
        print('\n' * 3)
...
def dieu():
    f = open('.\data\dieu.txt', 'r')
    print(f.read())
    input()

def copernic():
    f = open('.\data\copernic.txt', 'r')
    print(f.read())
    input()

def dieuTriste():
    f = open('.\data\dieutriste.txt', 'r')
    print(f.read())
    input()

def lune():
    f = open('.\data\lune.txt', 'r')
    print(f.read())
    input()

def kepler():
    f = open('.\data\kepler.txt', 'r')
    print(f.read())
    input()

def pomme():
    f = open('.\data\pomme.txt', 'r')
    print(f.read())
    input()
...
def louis():
    f = open('.\data\louis.txt', 'r')
    print(f.read())
    input()

def engrenage():
    f = open('.\data\engrenage.txt', 'r')
    print(f.read())
    input()

def bateau():
    f = open('.\data\\bateau.txt', 'r') # \\ parce que \b ça marche pas
    print(f.read())
    input()

def ble():
    f = open('.\data\\ble.txt', 'r') # \\ parce que \b ça marche pas
    print(f.read())
    input()

def monopoly():
    f = open('.\data\monopoly.txt', 'r')
    print(f.read())
    input()

def ordi():
    while True:
        f1 = open('.\data\ordi1.txt', 'r')
        f2 = open('.\data\ordi2.txt', 'r')
        print(f1.read())
        sleep(0.5)
        print(f2.read())
        sleep(0.5)

# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 21:52:02 2019
...
def inputPlayerLetter():
    ...
    while not (letter == 'X' or letter == 'O'):
        ...
        # the fisrt element in the list is the player's letter; the second is the computer's letter.
        if letter == 'X':
            return ['X', 'O']
        else:
            return ['O', 'X']
...
def isWinner(bo, le):
    ...
    # We use "bo" instead of "board" and "le" instaed of "letter" so we don't have to type as much.
